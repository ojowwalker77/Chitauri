...
/* Claude's brand coral. A literal, icon-local value on purpose: provider glyphs
   keep their brand identity (they are logos, not chrome), while the retired
   --claude chrome token stays dead per Design.md §2. */
...
export const ClaudeAI: Icon = ({ color, ...props }) => (
  ...
  >
    <path
      fill={typeof color === "string" ? color : CLAUDE_BRAND_COLOR}
