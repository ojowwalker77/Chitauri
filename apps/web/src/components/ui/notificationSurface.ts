...
export const COMPACT_NOTIFICATION_SURFACE_CLASS_NAME = `${OVERLAY_SURFACE_CLASS_NAME} w-max max-w-[min(calc(100vw-2rem),28rem)] rounded-[8px] dark:bg-[#262626] ${NOTIFICATION_FOREGROUND_CLASS_NAME} before:hidden [-webkit-app-region:no-drag]`;

export const EXPANDED_NOTIFICATION_SURFACE_CLASS_NAME = `${OVERLAY_SURFACE_CLASS_NAME} w-full rounded-[8px] dark:bg-[#262626] ${NOTIFICATION_FOREGROUND_CLASS_NAME} before:hidden [-webkit-app-region:no-drag]`;
