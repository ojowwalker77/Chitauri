    ...
    <SheetPortal keepMounted={keepMounted}>
      ...
      <SheetViewport side={side} variant={variant}>
        <SheetPrimitive.Popup
          className={cn(
            "relative flex max-h-full min-h-0 w-full min-w-0 flex-col bg-panel text-popover-foreground shadow-[0_16px_44px_rgba(0,0,0,0.5)] transition-[opacity,translate] duration-sheet ease-drawer motion-reduce:transition-none will-change-transform data-ending-style:opacity-0 data-starting-style:opacity-0",
            side === "bottom" &&
            ...
            variant === "inset" &&
              "sm:rounded-xl sm:border sm:border-panel-border sm:**:data-[slot=sheet-footer]:rounded-b-[calc(var(--radius-xl)-1px)]",
            className,
          )}
