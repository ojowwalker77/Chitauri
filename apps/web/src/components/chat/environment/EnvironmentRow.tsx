...
export const ENVIRONMENT_ROW_CLASS_NAME = cn(
  "flex min-h-[38px] w-full cursor-pointer items-center gap-2 rounded-lg px-2.5 py-1 text-left",
...
export function EnvironmentCollapsibleSection({
  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen} className="flex flex-col">
      <CollapsibleTrigger
        className={cn(
          "group/section flex min-h-[38px] w-full items-center justify-between gap-2 rounded-lg px-2.5 py-1 text-left",
          "outline-none transition-colors",
          "hover:bg-[var(--color-background-elevated-secondary)]",
          "focus-visible:bg-[var(--color-background-elevated-secondary)]",
        )}
