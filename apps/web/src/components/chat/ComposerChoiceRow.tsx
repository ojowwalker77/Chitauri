...
const CHIP_TONE_CLASS_NAME: Record<ComposerChoiceTone, string> = {
  ...
  gold: "border border-[color:color-mix(in_srgb,var(--gold)_55%,var(--color-border))] text-gold group-hover:border-[color:color-mix(in_srgb,var(--gold)_78%,var(--color-border))]",
  destructive:
