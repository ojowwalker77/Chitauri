...
export const CHAT_SURFACE_CHIP_CLASS_NAME = cn(
  ...
  "!h-8 gap-1.5 rounded-lg border-0 px-2.5 text-[length:var(--app-font-size-ui-sm,13px)] font-normal transition-colors duration-menu ease-out",
...
export const DOCK_TAB_CHIP_CLASS_NAME = cn(
  CHAT_SURFACE_CHIP_CLASS_NAME,
  "inline-flex min-w-0 items-center rounded-lg border border-transparent pr-2.5 data-[active=true]:border-panel-border data-[active=true]:bg-panel data-[active=true]:text-foreground",
);
