...
const ProjectionThreadDbRow = ProjectionThread.mapFields(
  Struct.assign({
    ...
    orchestratorMode: SqliteBoolean,
    ...
    execute: (row) =>
      sql`
        ...
        DO UPDATE SET
          ...
          workspace_id = COALESCE(excluded.workspace_id, projection_threads.workspace_id),
    ...
    execute: ({ threadId }) =>
      sql`
        SELECT
          ...
          orchestrator_mode AS "orchestratorMode",
