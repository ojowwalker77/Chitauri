...
// Imported instance ids may be runtime names rather than Chitauri provider literals.
...
export function normalizePersistedModelSelection(input: unknown): unknown {
  ...
  // option rows as [{ id, value }]; Chitauri stores canonical provider/options objects.
