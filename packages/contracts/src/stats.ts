...
// the shareable activity card. All metrics are backed by Chitauri's local DB
...
export const ProfileActivity = Schema.Struct({
  ...
  // totalPromptsSent), i.e. days the user actually used Chitauri.
...
// Token totals come from Chitauri's projected context-window updates. `available`
