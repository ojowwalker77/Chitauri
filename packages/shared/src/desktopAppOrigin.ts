...
export const DESKTOP_SCHEME = "chitauri";

/** Host segment of the packaged renderer URL (`chitauri://app/index.html`). */
export const DESKTOP_APP_HOST = "app";

// The packaged renderer is served from a non-special scheme, so `new URL(...).origin`
// serializes to the opaque "null" instead of `chitauri://app`. Every origin check
